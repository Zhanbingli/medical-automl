...
2. val_acc achieved (e.g. 0.854000) — use 0.000000 for crashes
...
```
commit	val_acc	memory_gb	status	description
a1b2c3d	0.854000	44.0	keep	baseline
b2c3d4e	0.862000	44.2	keep	increase LR to 0.04
c3d4e5f	0.845000	44.0	discard	switch to GeLU activation
